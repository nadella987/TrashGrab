    ...
    <div class="container-fluid product py-5 my-5">
        <div class="container py-5">
            ...
            <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                <a href="/kardus" class="d-block product-item rounded">
                ...
                <a href="/kertas" class="d-block product-item rounded">
                ...
                <a href="/kaca" class="d-block product-item rounded">
                ...
                <a href="/plastik" class="d-block product-item rounded">
                ...
                <a href="/kaleng" class="d-block product-item rounded">
                ...
                <a href="/besi" class="d-block product-item rounded">
